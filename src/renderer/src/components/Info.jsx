...
function Info() {
  return (
    <div className="w-[90%] h-screen m-auto flex flex-col justify-center items-center; gap-[1rem]">
      <div className="flex gap-[10px] items-center">
        <img src={logoImgUrl} alt="HotKey Logo" className="block w-[60px]" />
        <img
          src={textImgUrl}
          alt="HotKey Text"
          className="block w-[90px] h-[25px]"
        />
      </div>
      ...
      <div className="contentWrap w-fit flex flex-col">
        ...
        <div>
          <ul className="!list-disc leading-7 text-[#777] mb-[2rem]">
            ...
            <li className="ml-[1rem]">
              설정 창을 열고, 개인정보 보호를 클릭합니다.
            </li>
            <li className="ml-[1rem]">
              시작 메뉴 &gt; 설정 &gt; 개인정보 보호로 이동합니다.
            </li>
            <li className="ml-[1rem]">
              왼쪽 메뉴에서 일반을 클릭하고, 여러 옵션을 확인합니다.
            </li>
            <li className="ml-[1rem]">
          ...
          <ul className="!list-disc leading-7 text-[#777] mb-[2rem]">
            ...
            <li className="ml-[1rem]">
              카메라, 마이크, 위치, 알림 등 각 항목을 클릭하고 권한을 해제할 수
              있습니다.
            </li>
          </ul>
          <ul className="!list-disc leading-7 text-[#777] mb-[2rem]">
            ...
            <li className="ml-[1rem]">
              시스템 환경설정을 열고 보안 및 개인정보 보호로 이동합니다.
            </li>
            <li className="ml-[1rem]">
              상단 탭에서 개인정보 보호를 클릭합니다.
            </li>
            <li className="ml-[1rem]">
