...
function Info() {
  ...
  return (
    <div className="w-[90%] h-[700px] m-auto flex flex-col gap-[1rem]">
      <div className="w-[90%] h-[700px] m-auto flex flex-col gap-[1rem]">
        ...
        <div className="contentWrap w-fit flex flex-col">
          ...
          <div>
            <ul className="!list-disc leading-7 text-[#777] mb-[1.4rem]">
              ...
              <li className="ml-[1rem]">
                예를 들어, 앱이 내 정보에 액세스하도록 허용을 끄거나, 위치나
                음성 인식 등을 비활성화할 수 있어요!
              </li>
              <li className="ml-[1rem]">
            ...
            <ul className="!list-disc leading-7 text-[#777] mb-[1.4rem]">
              ...
              <li className="ml-[1rem]">
                카메라, 마이크, 위치, 알림 등 각 항목을 클릭하고 권한도 해제할
                수 있어요!
              </li>
            </ul>
            ...
            <ul className="!list-disc leading-7 text-[#777] mb-[1.4rem]">
              ...
              <li className="ml-[1rem]">
                여기서 위치 서비스, 마이크, 카메라, 연락처 등 각 항목에 대한
                앱의 권한을 관리할 수 있어요!
              </li>
              <li className="ml-[1rem]">
              ...
              <li className="ml-[1rem]">
                앱별로 전체 디스크 접근 권한, 하드웨어 리소스 접근 등을 수정할
                수 있어요!
              </li>
              <li className="ml-[1rem]">
                전체 디스크 접근 권한을 설정하려면, 시스템 환경설정 &gt; 보안 및
                개인정보 보호 &gt; 전체 디스크 접근에서 앱별로 권한을
                허용/거부할 수 있어요!
              </li>
            </ul>
          </div>
