...
2. [HotKey 기능 미리보기](#HotKey-기능-미리보기)
   - [사용시작 버튼 클릭 한번으로 활성 앱의 메뉴바 단축키 정보 수집](#사용시작-버튼-클릭-한번으로-활성-앱의-메뉴바-단축키-정보-수집)
   - [단축키 입력 시 전역 안내 화면 호출 기능](#단축키-입력-시-전역-안내-화면-호출-기능)
   - [입력 특수기호 키 기반 단축키 정보 필터링 기능 구현](#입력-특수기호-키-기반-단축키-정보-필터링-기능-구현)
   - [가상 키보드 기반 단축키 시각화 기능 구현](#가상-키보드-기반-단축키-시각화-기능-구현)
...
### 사용시작 버튼 클릭 한번으로 활성 앱의 메뉴바 단축키 정보 수집
