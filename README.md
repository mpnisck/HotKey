...
- 표준 macOS UI 순서 유지 (⌘ → ⌥ → ⇧ → ⌃) `AXMenuItemCmdModifiers` 모디파이어 키의 상태를 나타내며 숫자로 표현하였습니다.
...
- `AXMenuItemCmdChar` 실제 키보드의 문자(예: `B`, `S`, `C`)를 반환하며 단축키의 마지막 부분을 구성하였습니다.

- `subItemShortcut` 최종적으로 **모디파이어 키**와 **문자**를 결합하여 단축키를 만들고 담아주는 형식으로<br>
  예를 들어, 아래의 같은 형식으로 출력되게끔 구성하였습니다.<br>
...
- GitHub에서는 파일 1개 당 용량이 **50MB을 넘으면 warning, 100MB를 넘으면 error**로 판단하기 때문에,
  용량이 100MB를 초과하는 파일을 그냥 **commit** 후 **push**하게 되면 다음과 같은 **error가 발생** 하였습니다.
...
- Git 저장소의 크기와 속도를 최적화하여 대용량 파일 관리와 저장소 용량 문제, 버전 관리 효율성 등의 문제를 해결할 수 있었습니다.
...
| **화면 종류** | **이미지**                                                      |
| ------------- | --------------------------------------------------------------- |
| **초기 화면** | <img src="READMEIMG/image 0.png" alt="loading"  width="400px"/> |
| **개선 화면** | <img src="READMEIMG/image 1.png" alt="loading"  width="400px"/> |
...
| **화면 종류** | **이미지**                                                   |
| ------------- | ------------------------------------------------------------ |
| **초기 화면** | <img src="READMEIMG/image 2.png" alt="info"  width="400px"/> |
| **개선 화면** | <img src="READMEIMG/image 3.png" alt="info"  width="400px"/> |
...
| **화면 종류** | **이미지**                                                       |
| ------------- | ---------------------------------------------------------------- |
| **초기 화면** | <img src="READMEIMG/image 4.png" alt="keyboard"  width="400px"/> |
| **개선 화면** | <img src="READMEIMG/image 5.png" alt="keyboard"  width="400px"/> |
